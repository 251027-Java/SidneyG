...
(3, 'c@c.com', 100000, 100.00, 100.00),
(4, 'd@d.com', 100000, 100.00, 100.00),
(5, 'e@e.com', 100000, 100.00, 100.00);
-- We can not rerun this with new rows added since it is trying to override the original ones that were inserted.
-- if we want to do this we will have to make a new insert into command OR we could do ON CONFLICT
INSERT INTO mySampleSchema.myNewTable (id, email, salary, thirdSalary, fourthSalary)
VALUES
(1, 'a@a.com', 100000, 100.00, 100.00),
(2, 'b@b.com', 100000, 100.00, 100.00),
(3, 'c@c.com', 100000, 100.00, 100.00),
(4, 'd@d.com', 100000, 100.00, 100.00),
(5, 'e@e.com', 100000, 100.00, 100.00),
(6, 'f@f.com', 100000, 100.00, 100.00),
(7, 'g@g.com', 100000, 100.00, 100.00)
...
ON mysampleschema.anothersimpletable.newtbale_id = mysampleschema.mynewtable_id;

-- Referential integrity: a database principal that ensures relationship between tables are valid
