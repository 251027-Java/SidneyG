/*
Write a program to get the difference between the product of odd and even numbers of an array after removing duplicates from it.
Note: if the difference between even and odd numbers is negative, then make it positive before printing/ returning the result.
...
public class Main {
    static void main() {
        // Take int n input from user that is the length of the array
        // Create array of size n
        // Loop through and save user input as array[n]
